...
void status(int randomNum);    // shows bus and seats status
...
void cancel(int randomNum);    //cancel the booking 
BST *reservationInfo(BST *r, int s, int *custIDmatched); // Display Reservation Info
...
main:
  do
  {
    ...
    busSeatChoice:
      ...
      redColor();
      printf("%d\n", randomNum);
      printf("\nPLEASE NOTE DOWN YOUR RESERVATION NUMBER FOR CANCELLING BOOKED TICKETS!!\n");
      resetColor();
